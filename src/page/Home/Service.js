...
const Service = () => {
  return (
    <div className='py-12'>
      <h2 className='text-xl font-bold my-6 text-center'> Provide Awesome <span style={{ color: '#7AB259' }} className=''>Services</span></h2>

      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 px-12 py-12 '>
        <div className="lg:max-w-lg hover:shadow-xl p-6 text-center">
        ...
        <div>
          <div className="lg:max-w-lg bg-base-100 shadow-xl border-spacing-5 p-6 text-center">
